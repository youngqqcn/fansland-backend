...
<div style=width:100%; background-color:#E4E5E7;padding:2px;>
    <div style="max-width:640px; margin:0 auto; background:#ffffff;border-radius:10px; overflow:hidden;">
        ...
        <div style="padding:12px;">
            <h1 style="font-size:20px; font-weight:bold; text-align:center; color:black;"> Fansland NFT ticket Mint success! 🎉 </h1>
            <p style="margin:0;"><br></p>
            <p style="font-size:15px; line-height:170%; letter-spacing:0.2px;  margin:0; color:black;"> Congratulations! 👏</p>
            <p style="margin:0;"><br></p>
            <p style="font-size:15px; line-height:170%; letter-spacing:0.2px; margin:0; color:black;"> You have successfully mint Fansland NFT ticket.</p>
            <p style="margin:0;"><br></p>
            <p style="font-size:15px; line-height:170%; letter-spacing:0.2px; margin:0; color:black;">
            ...
            <ul>
                <li>
                    <p style="font-size:15px;   line-height:170%; letter-spacing:0.2px; margin:0; color:black;">
                    🎫 Ticket Type: <u>{ticketType}</u>
                    </p>
                </li>
                <li>
                    <p style="font-size:15px;   line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
                    🔗 Blockchain: <u>{chain} ({chainid})</u>
                    </p>
                </li>
                <li>
                    <p style="font-size:15px;   line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
                    👤 Wallet Address: <u>{address}</u>
                    </p>
                </li>
                <li>
                    <p style="font-size:15px;   line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
                    🆔 NFT Token Id: <u> #{token_id}</u>
                    </p>
                </li>
                <li>
                    <p style="font-size:15px;   line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
                    🗓️ Event Date: <u>{date}</u>
                    </p>
                </li>
                <li>
                    <p style="font-size:15px;   line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
                    🌏 Event Location: <u>{location}</u>
                    </p>
                </li>
                <li>
                    <p style="font-size:15px;   line-height:100%; letter-spacing:0.2px; margin:0;color:black;">
                     💾 Check-in QR Code:
                    </p>
                </li>
            </ul>
            ...
            <p style="text-align: center;">
              <a href="https://fansland.io" target="_blank"
                <button style="border: none; color: #FFF; font-size: 15px; font-weight: 600; border-radius: 12px; padding: 12px 24px; background: linear-gradient(251deg, #AE18FD 8%, #FC6512 90%);">View Event Details</button>
              </a>
            </p>
            <p style="margin:0;"><br></p>
            <p style="font-size:15px; line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
            ...
            <p style="margin:0;"><br></p>
            <p style="font-size:15px; line-height:170%; letter-spacing:0.2px; margin:0;color:black;">
                If you have any questions, you could email our support team at <a href="mailto:service@fansland.io">service@fansland.io</a>.
            </p>
            <p style="margin:0;"><br></p>
            <hr>
            <p style="text-align: center;">
            ...
            <p style="text-align: center; font-size:14px; font-weight: 300; line-height:90%; letter-spacing:0.2px;color:black;">
            ...
            <p style="color: #807E7E; font-size: 14px; text-align: center;color:black;">
